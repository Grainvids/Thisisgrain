...
Call log:
  - waiting for locator('button[type="submit"]')
    - locator resolved to <button type="submit" class="cta-button" data-astro-cid-j7pv25f6="">Send Message</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="nav-container" data-astro-cid-pux6a34n="">…</div> from <nav class="nav visible" data-astro-cid-pux6a34n="">…</nav> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    at /Users/jonny/Documents/github/Thisisgrain/e2e/quote-flow.spec.js:33:16
```
...
- main:
  ...
  - heading "CHLOE FOY - Elephant In The Room" [level=3]
  - paragraph: Live Performance
  - heading "VEGA TRAILS - Sleepwalk Tokyo" [level=3]
  - paragraph: Music Video
  - heading "Pablo Miller - Broken Mirror" [level=3]
  - paragraph: Live Performance
  - heading "Portico Quartet Ensemble - Terrain (Extended)" [level=3]
  - paragraph: Live Performance
  - heading "Caoilfhionn Rose - Constellation Sessions" [level=3]
  - paragraph: Live Performance
  - heading "LOTTERY WINNERS - UFO" [level=3]
  - paragraph: Music Video
  - heading "LOTTERY WINNERS - SUPERPOWER" [level=3]
  - paragraph: Music Video
  - heading "LOTTERY WINNERS - Ragdoll ft. Chad Kroeger" [level=3]
  - paragraph: Music Video
  - heading "Reytons feat. Gary Neville - Low Life" [level=3]
  - paragraph: Live Performance
