    ...
    <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-6 font-sans">
      ...
      <div className="space-y-4 p-6">
        ...
        <input
          ...
          className="w-full h-6 rounded-lg appearance-none cursor-pointer accent-[#FF3E00] focus:outline-none focus:ring-2 focus:ring-[#FF3E00] focus:ring-offset-2 [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#FF3E00] [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:shadow-lg [&::-moz-range-thumb]:w-6 [&::-moz-range-thumb]:h-6 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-[#FF3E00] [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:shadow-lg"
